...
/************************************************************************************************/
{
	...
	private OpenIntDoubleHashMap 	deviatedSphereSum;	 // contain the deviated (from respective average) sum for a movie in sphere
	...
	private OpenIntDoubleHashMap	radious =new OpenIntDoubleHashMap();				//radious of each cluster
	...
	public Centroid(int uid, MemHelper helper)    
	{
		...
		int mid;
		double rating;
		//System.out.println("checking it gone here.....");
		/*if(uid==405)
	...
	{
		//System.out.print(radious.get(sphere));
		return radious.get(sphere) ;   
	}
	...
	/************************************************************************************************/
	/**
	 * get average of the whole sphere (counted over all movie)
	 */
	...
	/************************************************************************************************/  
	 ...
	 //get radious of the  sphere (counted over all movie)
...
/************************************************************************************************/
	...
	// we add a user into a sphere, it means we add all its movies and ratings and update
	// sum and count as well
	...
	public void addPointSphereWithRadious(int uid, int id, MemHelper helper)    
	{
		...
		double dis= distanceWithDefaultSphere(uid, getSphereAverage() , helper);
		if (dis< 0.2 && dis > 0.00)
			{
			//System.out.print("radious updateddd");
			radious.put(id, dis);
			}
	}
	 ...
	 * Note that this method does not make sure that 
	 * the count and sum remain positive. Don't remove		//why not first check if that point is there?
	 * a point that's not in the sphere.
	 *
	 * DOES NOT UPDATE AVERAGE!								//we can update it?	
	 */
	...
	{    	
		...
		int 	userIndex, centroidIndex, userMid, centroidMid;
	...
	/************************************************************************************************/  
	//It is called for a specific centroid in sphere..
	...
	/************************************************************************************************/ 
	//It is called for a specific centroid sphere, we should not take the active user's info into account?
...
System.out.println("-------------------------------------------------------------");
    ...
    public double  findSimPCCBetweenACentroidAndUser (int center, int point, MemHelper helper)
    {
