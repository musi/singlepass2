...
public class MineSweeper extends JPanel implements AWTEventListener, ActionListener {
  ...
  public MineSweeper() {
	  //five components of bordr layout ...north east west and center
    setLayout(new BorderLayout());
    add(pnlMain, BorderLayout.CENTER);
    createButtons();
    addControlPanel();
    // key_event listner is a bit mask that define event event to deliever to this component...
    Toolkit.getDefaultToolkit().addAWTEventListener(this, AWTEvent.KEY_EVENT_MASK);
  }

  private void showAbout() {
    JOptionPane.showMessageDialog(this, "<html>Author : Umar Khalid <br>Version : 1.0</html>", "About", JOptionPane.INFORMATION_MESSAGE);
  }
  ...
  public static void main(String... args) {
	  ...
	  //frame creates a standard window with all buttons like resize close.....
